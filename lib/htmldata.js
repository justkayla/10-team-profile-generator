...
for (let i = 0; i < arrData.length; i++) {
    `<div class="card employee-card">
        <div class="header">
            <h2 class="card-title">${employeetype}</h2>
        </div>
        <div class="card-body">
            <ul class="list-group">
...
function writeToFile() {
    fs.writeFile('./dist/index.html', arrData, (err) =>
        err ? console.log("error") : console.log('HTML created!'))
}

module.exports = { generateHTML, employeeData, managerData, engineerData, internData, askAgain, init, writeToFile };